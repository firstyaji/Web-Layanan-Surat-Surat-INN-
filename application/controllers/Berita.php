...
class Berita extends CI_Controller
{
    ...
    public function save()
    {
        ...
        if (!empty($tmp_imgberita)) {
            if (
                $type_imgberita != "image/jpeg" and $type_imgberita != "image/jpg" and $type_imgberita != "image/png"
            ) {
    ...
    public function update()
    {
        ...
        if (!empty($tmp_imgberita)) {
            if (
                ...
                $data = array(
                    'judul_berita' => $this->input->post('judul_berita'), 'id_kategori' => $this->input->post('id_kategori'), 'isi_berita' => $this->input->post('isi_berita'), 'tgl_berita' => $this->input->post('tgl_berita'),
                    'jam_berita' => $this->input->post('jam_berita'), 'kd_admin' => $this->session->userdata('kd_admin'), 'img_berita' => $img_berita
                );
            }
        } else {
            $data = array(
