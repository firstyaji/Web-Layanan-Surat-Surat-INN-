...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-light-primary elevation-1" style="background-color: #CD5C5C;">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="<?php echo base_url() ?>assets/dist/img/adm.png" alt="User Image">
                    </div>
                    <div class="info">
                        <a href="#" class="d-block text-bold" style="font-size: 18px; color: white;">Kelurahan Kutoarjo</a>
                    </div>
                </div>
                <!-- Sidebar Menu -->
                <nav class="mt-2">
                    ...
                    <div class="container-fluid">
                        <div class="card card-default">
                            <div class="card-header"style="background-color: #D3B5E5 ;">
                                <h3 class="text-bold">Edit Nomor Surat </h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">                                                                        
                                            <!--Form-->                                          
                                            <form class="" action="<?php echo site_url('Pelayanan/update/' . $edit['nik']) ?>" method="post">
                                                <label>Nomor Surat</label><br>
                                                <input class="form-control" type="text" name="no_surat" value="<?php echo $edit['no_surat'] ?>">
                                                <p></p>

                                                <button type="submit" name="button" class="btn btn-dark btn-sm"><i class="fa fa-check"></i>Simpan</button>
                                                <a href="<?php echo site_url('Pelayanan') ?>" class="btn btn-danger btn-sm"><i class="fa fa-undo"> Kembali</i></a>
                                            </form>
                                        </div>                                    
                                    </div>                                    
                                </div>
        ...
        <footer class="main-footer">
            <strong>© Copyright Kelurahan Kutoarjo</strong>
        </footer>
