                    ...
                    <div class="container-fluid">
                        <div class="card card-default">
                            <div class="card-header">
                                <h3 class="text-bold">Edit Admin</h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <form class="" action="<?php echo site_url('Admin/update/' . $edit['kd_admin']) ?>" method="post">
                                                ...
                                                <input class="form-control" type="text" name="kd_admin" disabled value="<?php echo $edit['kd_admin'] ?>">
                                                <p></p>
                                                <input type="text" name="kd_admin" hidden value="<?php echo $edit['kd_admin'] ?>">
                                                <p></p>

                                                <label>Nama Admin</label><br>
                                                <input class="form-control" type="text" name="nama_admin" value="<?php echo $edit['nama_admin'] ?>">
                                                <p></p>
