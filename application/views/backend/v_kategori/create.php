                    ...
                    <div class="container-fluid">
                        <div class="card card-default">
                            <div class="card-header"style="background-color: #D3B5E5 ;">
                                <h3 class="text-bold">Buat Jenis Surat Baru</h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">                                                                        
                                            ...
                                            <form class="" action="<?php echo site_url('Kategori/save') ?>" method="post">
                                                <label>ID Jenis Surat</label><br>
                                                <input class="form-control" type="text" name="id_surat" value="">
                                                <p></p>

                                                <label>Jenis Surat Pengantar</label><br>
                                                <input class="form-control" type="text" name="jenis" value="">
                                                <p></p>

                                                <label>Kode Surat</label><br>
                                                <input class="form-control" type="text" name="kode_surat" value="">
                                                <p></p>

                                                <button type="submit" name="button" class="btn btn-dark btn-sm"><i class="fa fa-check"></i>Simpan</button>
                                                <a href="<?php echo site_url('Kategori') ?>" class="btn btn-danger btn-sm"><i class="fa fa-undo"> Kembali</i></a>
                                            </form>
                                        </div>                                    
                                    </div>                                    
                                </div>
